...
function Home() {
    return (
        <>
            <section className="flex-1 text-white bg-blue-50 flex flex-col md:flex-row items-center justify-center px-8 md:px-16">
                ...
                <div className="hidden md:block bg-blue-50 rounded-lg border border-blue-100 shadow-sm hover:shadow-xl cursor-pointer transition">
                    <img
                        src={logo}
                        alt="Redux Bag Hero"
                        height="350"
